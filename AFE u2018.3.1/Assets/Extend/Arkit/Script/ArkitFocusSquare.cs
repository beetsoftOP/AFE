...
public class ArkitFocusSquare : MonoBehaviour {
	...
	public bool isStartFocus = false;
	...
	public void StartScan(){
		isStartFocus = true;
		Debug.Log("Scan Focus Square !!");
	}
	public void StopScan(){
		isStartFocus = false;
		Debug.Log("Stop Focus Square !!");
	}
	...
	void Update () {
		...
		Debug.Log ("ARHitTestResultType = 4");
