...
extern const uint32_t WWW__ctor_m2633647279_MetadataUsageId;
extern const uint32_t WWW__ctor_m4096577320_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR void UnityWebRequest__ctor_m2386773268 (UnityWebRequest_t463507806 * __this, String_t* p0, String_t* p1, const RuntimeMethod* method);
// System.Void UnityEngine.Networking.UploadHandlerRaw::.ctor(System.Byte[])
extern "C" IL2CPP_METHOD_ATTR void UploadHandlerRaw__ctor_m1397254157 (UploadHandlerRaw_t25761545 * __this, ByteU5BU5D_t4116647657* p0, const RuntimeMethod* method);
// System.Void UnityEngine.Networking.UploadHandler::set_contentType(System.String)
extern "C" IL2CPP_METHOD_ATTR void UploadHandler_set_contentType_m2709466885 (UploadHandler_t2993558019 * __this, String_t* p0, const RuntimeMethod* method);
// System.Void UnityEngine.Networking.UnityWebRequest::set_uploadHandler(UnityEngine.Networking.UploadHandler)
extern "C" IL2CPP_METHOD_ATTR void UnityWebRequest_set_uploadHandler_m54574009 (UnityWebRequest_t463507806 * __this, UploadHandler_t2993558019 * p0, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR void WWW__ctor_m2633647279 (WWW_t3688466362 * __this, String_t* ___url0, ByteU5BU5D_t4116647657* ___postData1, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (WWW__ctor_m2633647279_MetadataUsageId);
	...
	UploadHandler_t2993558019 * V_0 = NULL;
	{
		...
		UnityWebRequest_t463507806 * L_2 = __this->get__uwr_0();
		NullCheck(L_2);
		UnityWebRequest_set_chunkedTransfer_m1735705240(L_2, (bool)0, /*hidden argument*/NULL);
		ByteU5BU5D_t4116647657* L_3 = ___postData1;
		UploadHandlerRaw_t25761545 * L_4 = (UploadHandlerRaw_t25761545 *)il2cpp_codegen_object_new(UploadHandlerRaw_t25761545_il2cpp_TypeInfo_var);
		UploadHandlerRaw__ctor_m1397254157(L_4, L_3, /*hidden argument*/NULL);
		V_0 = L_4;
		UploadHandler_t2993558019 * L_5 = V_0;
		NullCheck(L_5);
		UploadHandler_set_contentType_m2709466885(L_5, _stringLiteral3776665136, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_6 = __this->get__uwr_0();
		UploadHandler_t2993558019 * L_7 = V_0;
		NullCheck(L_6);
		UnityWebRequest_set_uploadHandler_m54574009(L_6, L_7, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_8 = __this->get__uwr_0();
		DownloadHandlerBuffer_t2928496527 * L_9 = (DownloadHandlerBuffer_t2928496527 *)il2cpp_codegen_object_new(DownloadHandlerBuffer_t2928496527_il2cpp_TypeInfo_var);
		DownloadHandlerBuffer__ctor_m914761499(L_9, /*hidden argument*/NULL);
		NullCheck(L_8);
		UnityWebRequest_set_downloadHandler_m970510352(L_8, L_9, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_10 = __this->get__uwr_0();
		NullCheck(L_10);
		UnityWebRequest_SendWebRequest_m489860187(L_10, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" IL2CPP_METHOD_ATTR void WWW__ctor_m4096577320 (WWW_t3688466362 * __this, String_t* ___url0, ByteU5BU5D_t4116647657* ___postData1, Dictionary_2_t1632706988 * ___headers2, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (WWW__ctor_m4096577320_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	String_t* V_0 = NULL;
	...
	{
		G_B3_0 = _stringLiteral1130393535;
		goto IL_001c;
	}

IL_0017:
	{
		G_B3_0 = _stringLiteral45808443;
	}
...
IL_001c:
	{
		...
		String_t* L_2 = V_0;
		UnityWebRequest_t463507806 * L_3 = (UnityWebRequest_t463507806 *)il2cpp_codegen_object_new(UnityWebRequest_t463507806_il2cpp_TypeInfo_var);
		UnityWebRequest__ctor_m2386773268(L_3, L_1, L_2, /*hidden argument*/NULL);
		__this->set__uwr_0(L_3);
		UnityWebRequest_t463507806 * L_4 = __this->get__uwr_0();
		NullCheck(L_4);
		UnityWebRequest_set_chunkedTransfer_m1735705240(L_4, (bool)0, /*hidden argument*/NULL);
		ByteU5BU5D_t4116647657* L_5 = ___postData1;
		...
		NullCheck(L_7);
		UploadHandler_set_contentType_m2709466885(L_7, _stringLiteral3776665136, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_8 = __this->get__uwr_0();
		UploadHandler_t2993558019 * L_9 = V_1;
		NullCheck(L_8);
		UnityWebRequest_set_uploadHandler_m54574009(L_8, L_9, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_10 = __this->get__uwr_0();
		DownloadHandlerBuffer_t2928496527 * L_11 = (DownloadHandlerBuffer_t2928496527 *)il2cpp_codegen_object_new(DownloadHandlerBuffer_t2928496527_il2cpp_TypeInfo_var);
		DownloadHandlerBuffer__ctor_m914761499(L_11, /*hidden argument*/NULL);
		NullCheck(L_10);
		UnityWebRequest_set_downloadHandler_m970510352(L_10, L_11, /*hidden argument*/NULL);
		Dictionary_2_t1632706988 * L_12 = ___headers2;
		NullCheck(L_12);
...
IL_0071:
		{
			...
			V_2 = L_14;
			UnityWebRequest_t463507806 * L_15 = __this->get__uwr_0();
...
IL_00b1:
	{
		UnityWebRequest_t463507806 * L_19 = __this->get__uwr_0();
		NullCheck(L_19);
		UnityWebRequest_SendWebRequest_m489860187(L_19, /*hidden argument*/NULL);
		return;
	}
}
