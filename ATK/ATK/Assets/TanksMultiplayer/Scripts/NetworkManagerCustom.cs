...
namespace TanksMP
{
	...
	public class NetworkManagerCustom : NetworkManager
	{
        ...
        /// <summary>
        /// Starts initializing and connecting to the matchmaker for a game to join.
        /// Tries to retrieve a list of all games currently available on the matchmaker.
        /// </summary>
        public static void StartMatch()
        {
            NetworkManager.singleton.StartMatchMaker();
            NetworkManager.singleton.matchMaker.ListMatches(0, 20, "", false, 0, 0, NetworkManagerCustom.singleton.OnMatchList);
        }
